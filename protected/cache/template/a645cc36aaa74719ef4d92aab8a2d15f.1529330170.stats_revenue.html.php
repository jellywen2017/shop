...
function showChart(year){
  $.ajax({
    type: "post",
    dataType: "json",
    url: "<?php echo url(array('m'=>$MOD, 'c'=>'stats', 'a'=>'revenue', 'step'=>'search', ));?>",
    ...
    <div class="module">
      <table class="datalist">
        ...
        <tr>
          ...
          <td class="red ta-l"><?php if (!empty($v['revenue'])) : ?><?php echo htmlspecialchars($v['revenue'], ENT_QUOTES, "UTF-8"); ?><?php else : ?>0.00<?php endif; ?></td>
        </tr>
        <?php endforeach; ?>
      </table>
    </div>
    <div class="bw-row mt5 pad10 ta-c cut">
      <div class="bw-row pad10 cut">
        <label>
          ...
          <?php echo html_date_options(array('type'=>"year", 'start_year'=>"-10", 'default'=>$def_year, ));?>
          </select>
        </label>
